				...
				switch(parent.top_frame.instruction_array[x].pipeline_stage){
					...
					case "ID" :
						...
						for (i = (x - 1); i >= 0 ; i--){
							...
							// If the destination registers are the same for both instructions
							else if ((parent.top_frame.instruction_array[i].destination_register == parent.top_frame.instruction_array[x].destination_register)){
